...
import { SessionTokenDataAccess } from "../../../app/serverApp/data/SessionTokenDataAccess";
import { UserCredentialsDataAccess } from "../../../app/serverApp/data/UserCredentialsDataAccess";
...
jest.mock('../../../app/serverApp/data/SessionTokenDataAccess', () => {
    return {
...
jest.mock('../../../app/serverApp/data/UserCredentialsDataAccess', () => {
    return {
